...
class Plugin {
    ...
    move(fromPlanet, artifactId, rip) {
        ...
        for (let candidate of candidates) {
            ...
            if (fromPlanet.energy >= energyNeeded) {
                df.move(fromId, toId, energyNeeded, 0, artifactId, null, false);
    ...
    automove(artifactPlanet, rips) {
        ...
        for (let artifactId of artifactPlanet.heldArtifactIds) {
            ...
            if (artifact.unconfirmedWithdrawArtifact || artifact.unconfirmedMove || artifact.unconfirmedDeactivateArtifact || artifact.artifactType >= 10) {

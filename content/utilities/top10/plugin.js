...
.forEach(function(item,index,array){
  ...
  let newRow = [name,Math.round(item.withdrawnSilver/1000),Math.round(item.totalArtifactPoints/1000),Math.round((item.withdrawnSilver+item.totalArtifactPoints)/1000)]
  table.push(newRow);
});

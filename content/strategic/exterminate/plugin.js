...
const players = [
  "0xca84bc474d0f823a3b3f36ce4818ff2d81c002cb"
];
...
class Plugin {
  ...
  render(container) {
    ...
    button.innerHTML = 'Attack from selected!'
    button.onclick = () => {
      ...
      if (planet) {
        ...
        const typeName = `${typeNames[this.planetType]}s` || '(everything)';
        message.innerText = `Attacking ${moves} ${typeName}.`;
      } else {
    ...
    globalButton.innerHTML = 'Attack everything!'
